...
params: 
    desc: "Compound verbs are exactly that: combining two verbs to function as one."
    author: Andrew Nguyen 
---



Compound verbs are created by taking the polite form of a verb and replacing the ～ます with a secondary verb. 



# {{< heading "Initiation" >}}
**～始める** and **～出す** refer to the initiation of the main verb. They cannot be used with instantaneous main verbs, unless the action happens repeatedly such that a beginning can be marked. The difference between these two is that ～出す is more dramatic. Additionally, ～始める emphasizes volition, whereas ～出す doesn't imply control.
